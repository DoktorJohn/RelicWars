...
namespace Project.Modules.UI.Windows.Implementations
{
    public class StableWindowController : BaseWindow
    {
        ...
        public override void OnOpen(object dataPayload)
        {
            ...
            _statsContainer = Root.Q<ScrollView>("Stable-Stats-List");
        ...
        private void RefreshData(Guid cityId)
        {
            ...
            StartCoroutine(NetworkManager.Instance.Building.GetStableInfo(cityId, token, (dataList) =>
            {
        ...
        private void PopulateTable(List<StableInfoDTO> dataList)
        {
        ...
        private void CreateTableRow(StableInfoDTO item)
        {
            ...
            // Status Cell
            string statusText = item.IsCurrentLevel ? "Breeding Active" : "Upgrade Available";
            ...
            if (item.IsCurrentLevel)
            {
                // Orange / Cavalry farve (#FFB06E)
                statusLabel.style.color = new StyleColor(new Color(1f, 0.69f, 0.43f));
            }
