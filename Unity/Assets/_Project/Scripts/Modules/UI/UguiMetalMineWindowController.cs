...
{
    public sealed class UguiMetalMineWindowController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _amountHeaderLabel = amountHeader != null
                ...
                : null;
            _rowTemplate = FindTransform(transform, "MetalMineBuildingLevelDataRow")?.gameObject;
            _rowsRoot = _rowTemplate != null ? _rowTemplate.transform.parent : null;

            SetText(_amountHeaderLabel, "METAL / HOUR");
