...
{
    public partial class WorkshopWindowController : BaseWindow
    {
        ...
        public override void OnOpen(object dataPayload)
        {
            ...
            {
                WindowAsyncStateHelper.ShowError(_unitTabsScrollContainer, "Workshop unavailable.");
            ...
            ExecuteRefreshWorkshopBuildingData(version);
        }
        ...
        private void ExecuteRefreshWorkshopBuildingData(int version)
        {
            string token = NetworkManager.Instance.JwtToken;
            WindowAsyncStateHelper.ShowLoading(_unitTabsScrollContainer, "Loading workshop...");
            ...
            StartCoroutine(NetworkManager.Instance.Workshop.GetWorkshopOverviewInformation(_currentActiveCityId, token, (data) =>
            {
                ...
                {
                    WindowAsyncStateHelper.ShowEmpty(_unitTabsScrollContainer, "No workshop units available.");
                    WindowAsyncStateHelper.SetButtonsEnabled(new[] { _executeRecruitButton }, true);
                    CompleteDeferredOpen(version);
                    return;
                }
