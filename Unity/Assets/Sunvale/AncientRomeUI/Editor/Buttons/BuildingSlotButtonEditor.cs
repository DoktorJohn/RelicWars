...
{
    [CustomEditor(typeof(BuildingSlotButton))]
    public class BuildingSlotButtonEditor : UnityEditor.Editor
    {
        private Texture2D packIcon;

        private const string Description =
            "Building slot button with shared HSV material tweening, frame pixels-per-unit tweening, " +
            "click scale, empty-plus mode, level label, and manager-controlled radial fill.";
