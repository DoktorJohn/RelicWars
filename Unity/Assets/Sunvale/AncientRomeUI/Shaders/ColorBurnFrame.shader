Shader "UI/ColorBurnFrame"
{
    Properties
    {
        ...
        // Standard UI Masking properties
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // Sample texture and apply UI Color/Tint.
                ...
                color.rgb = applyGreyscaleLock(color.rgb);

               
                color.rgb = saturate(lerp(half3(1, 1, 1), color.rgb, color.a));
