...
{
    [CustomEditor(typeof(HorizontalRawImageTiler))]
    public class HorizontalRawImageTilerEditor : UnityEditor.Editor
    {
        private Texture2D packIcon;

        private const string Description =
            "When using a normal Unity Image with tiling, for example with a horizontally tiling sprite, changing the height also causes the image to tile vertically.\n\n" +
            "This component solves that problem: it tiles horizontally while still allowing the image to stretch vertically like a normal Image.";
