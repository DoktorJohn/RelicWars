...
{
    [CustomEditor(typeof(ToggleSoundCompanion))]
    public class ToggleSoundCompanionEditor : UnityEditor.Editor
    {
        private Texture2D packIcon;

        private const string Description =
            "Adds hover and click sound feedback to a normal Unity Toggle without replacing the Toggle component.";
