...
{
    [CustomEditor(typeof(UIGlobalTextureTiling))]
    public class UIGlobalTextureTilingEditor : UnityEditor.Editor
    {
        private Texture2D packIcon;

        private const string Description =
            "This forces multiple images that tile the same texture to sample it using the same global coordinates.\n\n" +
            "As long as two images with this script use the same texture and the same global scale multiplier, they will blend seamlessly.";
