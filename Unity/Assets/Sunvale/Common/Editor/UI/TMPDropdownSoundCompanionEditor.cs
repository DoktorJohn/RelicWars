...
{
    [CustomEditor(typeof(TMPDropdownSoundCompanion))]
    public class TMPDropdownSoundCompanionEditor : UnityEditor.Editor
    {
        private Texture2D packIcon;

        private const string Description =
            "Adds hover, click, and value-change sound feedback to a normal TMP Dropdown.\n\n" +
            "It also clears the highlighted state after the dropdown closes so the UI returns to idle cleanly.";
