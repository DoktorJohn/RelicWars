...
builder.Services.AddSingleton<ResearchPrerequisiteEvaluator>();
builder.Services.AddSingleton<UnitAvailabilityEvaluator>();
...
builder.Services.AddScoped<IDailyObjectiveRepository, DailyObjectiveRepository>();
...
builder.Services.AddScoped<IResearchRateCalculator, ResearchRateCalculator>();
builder.Services.AddScoped<ResearchProgressService>();
...
builder.Services.AddScoped<IDailyObjectiveService, DailyObjectiveService>();
builder.Services.AddScoped<IJwtService, JwtService>();
builder.Services.AddSingleton<CityWorker>();
builder.Services.AddScoped<NPCBuildingWorker>();
builder.Services.AddScoped<UnitDeploymentWorker>();
builder.Services.AddScoped<RankingSnapshotWorker>();
...
builder.Services.AddScoped<IHarborService, HarborService>();
...
builder.Services.AddScoped<DeploymentTransportCapacityService>();
builder.Services.AddScoped<UnitMovementCalculator>();
builder.Services.AddScoped<CombatSimulatorService>();
